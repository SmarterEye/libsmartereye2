...
class PipelineProfile {
 public:
  ...
  explicit PipelineProfile(std::shared_ptr<PipelineProfile> profile) : pipeline_profile_(std::move(profile)) {}

  explicit operator bool() const { return pipeline_profile_ != nullptr; }
  explicit operator std::shared_ptr<PipelineProfile>() { return pipeline_profile_; }
 ...
 private:
  ...
  std::shared_ptr<PipelineProfile> pipeline_profile_;
};
